    ...
    internal class Program
    {
        ...
        static void Exercicio5()
        {
            Console.WriteLine("O que você deseja manipular: \n" +
                ...
                "2 - Inverte \n" +
                "3 - Conta - retorna o número de letras maiúscula e minúscula");
            ...
            switch (entrada)
            {
                case "1":
                    ...
                    ManipulaString fullname = new ManipulaString(nomeCompleto);
                    fullname.Iniciais();
                    break;

                case "2":
                    Console.WriteLine($"Entre com o texto a ser invertido.");
                    string cadeiaCaracteres = Console.ReadLine();
